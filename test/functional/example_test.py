...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the HarzcoinTestFramework
    pass

class ExampleTest(HarzcoinTestFramework):
    # Each functional test is a subclass of the HarzcoinTestFramework class.
    ...
    def custom_method(self):
        ...
        HarzcoinTestFramework class so other tests can use it."""
