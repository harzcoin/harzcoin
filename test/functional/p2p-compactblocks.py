...
# TestNode: A peer we use to send messages to harzcoind, and store responses.
...
class CompactBlocksTest(HarzcoinTestFramework):
    ...
    # This test actually causes harzcoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that harzcoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for harzcoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # harzcoind will not send blocktxn responses for blocks whose height is
