...
unlocked to sign the Harzcoin-Qt.app bundle.
...
allowing somebody to distribute a Harzcoin-Qt.app or harzcoin-qt-setup.exe with a valid
...
that the harzcoin-qt.exe file inside the installer had not been tampered with.
