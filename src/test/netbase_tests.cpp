...
{
    BOOST_CHECK(TestSplitHost("www.harzcoin.org", "www.harzcoin.org", -1));
    BOOST_CHECK(TestSplitHost("[www.harzcoin.org]", "www.harzcoin.org", -1));
    BOOST_CHECK(TestSplitHost("www.harzcoin.org:80", "www.harzcoin.org", 80));
    BOOST_CHECK(TestSplitHost("[www.harzcoin.org]:80", "www.harzcoin.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:1142", "127.0.0.1", 1142));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:1142", "127.0.0.1", 1142));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:1142", "::ffff:127.0.0.1", 1142));
    BOOST_CHECK(TestSplitHost("[::]:1142", "::", 1142));
    BOOST_CHECK(TestSplitHost("::1142", "::1142", -1));
    BOOST_CHECK(TestSplitHost(":1142", "", 1142));
    BOOST_CHECK(TestSplitHost("[]:1142", "", 1142));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:1142", "127.0.0.1:1142"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:1142", "[::]:1142"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
