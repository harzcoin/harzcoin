...
#ifndef HARZCOIN_TEST_SCRIPTNUM10_H
#define HARZCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Harzcoin Core 0.10.0, for cross-comparison.
 */
public:
