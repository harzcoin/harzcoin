...
#ifndef HARZCOIN_WALLET_WALLET_H
#define HARZCOIN_WALLET_WALLET_H
...
public:
     ...
     * on this harzcoin node, and set to 0 for transactions that were created
...
#endif // HARZCOIN_WALLET_WALLET_H
