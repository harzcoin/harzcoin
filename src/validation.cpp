...
#if defined(NDEBUG)
# error "Harzcoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Harzcoin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s THALER additional fees, %d delta bytes\n",
...
{
    // Harzcoin: 100% of all coins are mined in the first block
    if (nHeight == 1)
...
void ThreadScriptCheck() {
    RenameThread("harzcoin-scriptch");
