 ...
 * between harzcoind, and harzcoin-qt and non-server tools.
*/
...
#ifndef WIN32
    strUsage += HelpMessageOpt("-pid=<file>", strprintf(_("Specify pid file (default: %s)"), HARZCOIN_PID_FILENAME));
#endif
...
{
    const std::string URL_SOURCE_CODE = "<https://gitlab.com/harzcoin/harzcoin>";
    const std::string URL_WEBSITE = "<https://core.harzcoin.org>";
...
/** Sanity checks
 *  Ensure that Harzcoin is running in a usable environment with all
...
static bool LockDataDirectory(bool probeOnly)
{
    ...
    // Make sure only a single Harzcoin process is using the data directory.
...
bool AppInitMain(boost::thread_group& threadGroup, CScheduler& scheduler)
{
    ...
    LogPrintf("Using config file %s\n", GetConfigFile(gArgs.GetArg("-conf", HARZCOIN_CONF_FILENAME)).string());
