...
This document provides guidelines for internationalization of the Harzcoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `harzcoin_en.ts` remains unchanged.
