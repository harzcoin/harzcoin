...
Below are some notes on how to build Harzcoin Core for Windows.
...
way. This will install to `c:\workspace\harzcoin`, for example:

    make install DESTDIR=/mnt/c/workspace/harzcoin
